      ...
      connection.query(
        ...
        (error, result) => {
          ...
          if (result.length != 0) {
            ...
            connection.query(
              "select hims_f_billing_header_id, hims_f_billing_details_id, service_type_id as servtype_id, services_id as service_id,\
              quantity, unit_cost ,gross_amount as extended_cost,discount_amout as discount_amount,net_amout as net_amount,\
              patient_payable as patient_share,company_payble as company_share,sec_company_paybale\
