...
let getPosEntry = (req, res, next) => {
  ...
  try {
    ...
    db.getConnection((error, connection) => {
      connection.query(
        "SELECT hims_f_pharmacy_pos_header_id,PH.pos_number,PH.patient_id,P.patient_code,P.full_name as patient_name,PH.visit_id,V.visit_code,PH.ip_id,PH.pos_date,PH.recieve_amount,PH.year,\
