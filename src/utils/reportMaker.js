   ...
   and   BH.record_status='A'  and BD.record_status='A'  group by BD.services_id ",
      ...
      },
      {
        ...
        reportQuery:
          ...
          P.patient_code,P.full_name as patient_name,V.hims_f_patient_visit_id,SD.sub_department_code,SD.sub_department_name,\
      ...
      },
      {
        ...
        reportQuery:
          ...
          RH.hims_f_receipt_header_id,RH.receipt_number,RH.pay_type, RD.hims_f_receipt_details_id,RD.pay_type,RD.amount,\
          P.patient_code,P.full_name as patient_full_name,V.hims_f_patient_visit_id,SD.sub_department_code,\
          ...
          where date(pos_date) between date(?) and date(?) RH.pay_type='R' and\
