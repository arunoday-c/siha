  ...
  let queries = {
    algaehSeach: [
      ...
      },
      {
        searchName: "REQEntry",
        searchQuery:
          "select SQL_CALC_FOUND_ROWS * from hims_f_pharamcy_material_header where hospital_id=" +
          hospitalId,
      ...
      },
      {
        ...
        searchQuery:
          ...
          inner join hims_d_employee E on UM.employee_id=E.hims_d_employee_id where UM.hospital_id=" +
          hospitalId,
