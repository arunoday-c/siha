...
const executePDF = function executePDFMethod(options) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      options.mysql
        .executeQuery({
          query: `SELECT BH.bill_number,BH.bill_date, P.hims_d_patient_id,P.full_name, P.patient_code,  N.nationality,
        ...
        .then((ress) => {
          const BillWise = _.chain(ress)
            ...
            .map((billNo) => {
              const { full_name, patient_code, nationality } = billNo[0];
