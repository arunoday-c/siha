    ...
    try {
      ...
      options.mysql
        .executeQuery({
          ...
          Where ECC.record_status='A' and patient_id=? and episode_id=?;
          -- ICD
          ...
          inner join hims_d_employee  E on RO.provider_id=E.hims_d_employee_id where 1=1 and  V.patient_id=? and RO.visit_id=?
