    ...
    try {
      ...
      options.mysql
        .executeQuery({
          ...
          IM.item_code,IM.item_description,UOM.uom_description,IM.item_type,IM.purchase_cost, ROUND(sum(ILM.qtyhand),0) as qty_hand,
          ...
          inner join hims_d_inventory_uom UOM on UOM.hims_d_inventory_uom_id = IM.sales_uom_id 
