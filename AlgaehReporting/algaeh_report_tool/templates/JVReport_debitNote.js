const executePDF = function executePDFMethod(options) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      options.mysql
        .executeQuery({
          query: `SELECT AD.account_name, AD.arabic_account_name,VD.voucher_no,CD.ledger_code, CD.child_name,CD.arabic_child_name, FD.debit_amount, FD.credit_amount, FD.payment_type, FD.payment_date, FD.narration as narration_detail,VD.narration as narration_head
