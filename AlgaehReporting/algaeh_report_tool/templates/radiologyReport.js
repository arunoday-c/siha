const executePDF = function executePDFMethod(options) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      options.mysql
        .executeQuery({
          query: `select hims_f_rad_order_id,P.patient_code,trim(E.full_name) as doctor_name,P.full_name as patient_name,SD.sub_department_name,
          P.gender, V.age_in_years,   V.age_in_months,V.age_in_days, IP.insurance_provider_name, P.primary_id_no,
          ...
          inner join hims_f_patient_visit V on V.hims_f_patient_visit_id = RO.visit_id
          ...
          left join hims_m_patient_insurance_mapping IM on IM.patient_visit_id=RO.visit_id
