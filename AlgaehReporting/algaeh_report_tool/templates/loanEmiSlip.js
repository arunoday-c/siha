const executePDF = function executePDFMethod(options) {
    return new Promise(function (resolve, reject) {
      try {
        ...
        options.mysql
          .executeQuery({
            query: `SELECT HO.hospital_name,EM.employee_code,EM.full_name,LM.loan_description,LO.loan_application_number,LO.start_month,LO.start_year,SL.salary_number,
