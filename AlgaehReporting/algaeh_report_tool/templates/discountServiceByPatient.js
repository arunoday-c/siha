...
const executePDF = function executePDFMethod(options) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      options.mysql
        .executeQuery({
          query: `SELECT BH.patient_id, PT.patient_code,PT.full_name,V.visit_code,V.visit_date,ST.service_type,S.service_name,BD.unit_cost,BD.gross_amount,BD.net_amout,BD.discount_amout,BH.bill_number,BH.bill_date,  BH.hospital_id
          ...
          inner join hims_f_patient_visit V on BH.visit_id = V.hims_f_patient_visit_id where discount_amout>0 ${strQuery};`,
          // values: [],
          printQuery: true,
        })
        .then((res) => {
