      ...
      options.mysql
        .executeQuery({
          query:
            ...
            IU.uom_description,IC.category_desc, PTH.transaction_total,INVL.location_description, CH.consumption_date, CH.consumption_number, PTH.transaction_type FROM hims_f_pharmacy_trans_history PTH \
            inner join hims_d_item_master IM  on IM.hims_d_item_master_id = PTH.item_code_id \
