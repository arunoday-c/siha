      ...
      options.mysql
        .executeQuery({
          query:
            ...
            IU.uom_description, PTH.transaction_total,INVL.location_description, CH.consumption_date, CH.consumption_number, PTH.transaction_type FROM hims_f_inventory_trans_history PTH \
