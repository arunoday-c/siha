    ...
    try {
      ...
      options.mysql
        .executeQuery({
          ...
          left join hims_d_sub_department SDEP on (SDEP.hims_d_sub_department_id = V.sub_department_id or SDEP.hims_d_sub_department_id = ADM.sub_department_id)

          where SL.patient_id=? and SL.episode_id = ? ${str} ;`,
