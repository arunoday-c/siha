    ...
    try {
      ...
      options.mysql
        .executeQuery({
          ...
          where EM.employee_status <> 'I' and LD.year=? and LD.month = ? and EM.leave_salary_process='Y' and S.salary_processed ='Y' ${str} group by LH.employee_id order by EM.employee_code;
