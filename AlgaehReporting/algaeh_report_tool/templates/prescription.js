  ...
  return new Promise(function (resolve, reject) {
    try {
      ...
      options.mysql
        .executeQuery({
          query: `
          select G.generic_name, I.item_description, P.full_name as pat_name, V.visit_date, P.patient_code, 
          V.age_in_years, P.gender, P.contact_number, trim(N.nationality)as nationality,  S.sub_department_name, 
