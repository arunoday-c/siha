    ...
    try {
      ...
      options.mysql
        .executeQuery({
          ...
          date(H.return_date) as return_date ,  H.po_return_from, ROUND(H.return_total,
          ${decimal_places}) as return_total,D.hims_f_procurement_po_return_detail_id,
          D.phar_item_id,ROUND(D.net_extended_cost, ${decimal_places}) as net_extended_cost,
          D.batchno,D.vendor_batchno,  ROUND(D.tax_amount, ${decimal_places}) as tax_amount, 
          ROUND(D.total_amount, ${decimal_places}) as total_amount,
          D.expiry_date,L.location_description,IM.item_code, IM.item_description,V.vendor_name,
          U.uom_description,ROUND(D.dn_quantity, 0) as dn_quantity, 
          ...
          ${decimal_places}) as extended_cost,D.discount_percentage, GRN.grn_number,GRN.inovice_number, GRN.invoice_date,PO.purchase_number
          ...
          left join hims_d_pharmacy_location L on H.pharmcy_location_id=L.hims_d_pharmacy_location_id 
          ...
          where H.po_return_from='PHR' and purchase_return_number=?;`,
