...
export default {
  ...
  getFinanceOption: (req, res, next) => {
    ...
    _mysql
      .executeQuery({
       ...
       allow_negative_balance,grni_required,default_currency ,cr_dr_required,show_cash_cash from finance_options F
  ...
  updateFinanceOption: (req, res, next) => {
    ...
    _mysql
      ...
      allow_negative_balance=?,grni_required=?,cr_dr_required=?,show_cash_cash=?
