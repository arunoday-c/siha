...
export default {
  ...
  getCustomerInvoiceDetails: (req, res, next) => {
    ...
    _mysql
      .executeQuery({
        query: ` select MAX(H.finance_voucher_header_id) as finance_voucher_header_id,MAX(H.day_end_header_id) as day_end_header_id, round(H.amount ,2) as invoice_amount,
