      ...
      var PDFViewerApplication = {
        ...
        download: function download() {
          ...
          function downloadByUrl() {
            consoel.log("viewer filename", filename);
          ...
          this.pdfDocument
            ...
            .then(function (data) {
              ...
              const fName = new URLSearchParams(window.location.search).get(
                "filename"
              );
              if (fName) {
                filename = fName;
            ...
            },
            {
              ...
              value: function render(_ref5) {
                ...
                while (queue.length > 0) {
                  ...
                  try {
                    for (
                      var _iterator2 = levelData.items[Symbol.iterator](),
                        _step2;
                ...
                if (hasAnyNesting) {
                  ...
                  this.lastToggleIsShow =
                    fragment.querySelectorAll(".outlineItemsHidden").length ===
                    0;
                }
