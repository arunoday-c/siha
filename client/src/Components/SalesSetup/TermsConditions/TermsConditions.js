          ...
          <div className="col-12">
            <div className="portlet portlet-bordered margin-bottom-15">
              <div className="portlet-body">
                {" "}
                <div className="row" data-validate="visitDiv">
                  <div className="col">
                    <AlgaehDataGrid
                      ...
                      columns={[
                            ...
                            return (
                              <span>
                                <i
                                  ...
                                  onClick={this.EditTermsandConditions.bind(
                                    this,
                                    row
                                  )}
                                />
                        ...
                        },
                        {
                          fieldName: "short_name",
                          label: (
                            <AlgaehLabel label={{ fieldName: "short_name" }} />
                          ),
                          disabled: true,
                          others: {
                            maxWidth: 250
                        ...
                        },
                        {
                          ...
                          label: (
                            <AlgaehLabel
                              label={{ fieldName: "terms_cond_description" }}
                            />
                          ),
                          others: {
