...
// import AppointmentBeta from "../AppointmentBeta/Appointment";
import AppointmentBeta from "../AppointmentBeta/index";
      ...
      <div className="front-desk">
        <div>
          ...
          <button
            style={{
              display:
                this.state.FD_Screen === "AppointmentBeta" ? "none" : "block",
            }}
