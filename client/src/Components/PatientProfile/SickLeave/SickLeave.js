...
import { AlgaehDateHandler, AlgaehLabel, AlagehFormGroup, AlgaehModalPopUp } from '../../Wrapper/algaehWrapper';
...
class SickLeave extends Component {
	...
	onClose = (e) => {
		this.setState({ from_date: null, to_date: null, no_of_days: 0, remarks: '' }, () => {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SickLeave));
