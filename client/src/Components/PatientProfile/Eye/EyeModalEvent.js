  ...
  return {
    ...
    SaveGlassPrescription: ($this) => {
      ...
      let inputObj = {
        ...
        prescription_date: moment($this.state.prescription_date, "YYYY-MM-DD").format("YYYY-MM-DD"),
      ...
      for (let item in inputObj) {
        // if (inputObj[item] !== null && inputObj[item] !== undefined) {
        //   input[item] = inputObj[item].toString();
        // } else {
        //   input[item] = inputObj[item]
        // }
        if (typeof (inputObj[item]) === 'number') {
          input[item] = inputObj[item].toString();
        } else {
          input[item] = inputObj[item]
        }
      ...
      if ($this.state.hims_f_glass_prescription_id === null) {
        ...
        input.hims_f_glass_prescription_id = $this.state.hims_f_glass_prescription_id
        algaehApiCall({
