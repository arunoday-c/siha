...
class PatientHistory extends Component {
	...
	render() {
		const history = this.props.patient_history !== undefined ? this.props.patient_history : [];
		...
		return (
			...
			>
				<div className="popupInner">
					<div className="row">
						<div className="col-4">
							<div className="popLeftDiv" style={{ paddingTop: 10, paddingBottom: 0 }}>
								<div className="row">
									<div className="col-12 historySepration">
										...
										<small className="float-right">
											...
											{maxCharactersLeft(this.socialHistoryMaxLength, this.state.social_history)}
										</small>
									</div>
									<div className="col-12 historySepration">
										<AlgaehLabel
									...
									<div className="col-12 historySepration">
										...
										<small className="float-right">
											...
											{maxCharactersLeft(this.familyHistoryMaxLength, this.state.family_history)}
										</small>
									</div>
									<div className="col-12 historySepration">
										<AlgaehLabel
										...
										<small className="float-right">
											...
											{maxCharactersLeft(this.birthHistoryMaxLength, this.state.birth_history)}
										</small>
									</div>
								</div>
							</div>
						...
						<div className="col-8" style={{ paddingLeft: 0 }}>
							<div className="popRightDiv" style={{ paddingLeft: 0 }}>
								{history.map((item, index) => (
									<table className="table table-sm table-bordered customTable" key={index}>
										<thead className="">
											<tr>
