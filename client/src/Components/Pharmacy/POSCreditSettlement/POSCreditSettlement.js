	...
	render() {
		return (
			<div className="" style={{ marginBottom: '50px' }}>
				<BreadCrumb
					title={<AlgaehLabel label={{ forceLabel: 'POS Credit Settlement', align: 'ltr' }} />}
					...
					soptlightSearch={{
						label: <AlgaehLabel label={{ fieldName: 'pos_credit_number', returnText: true }} />,
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(POSCreditSettlement));
