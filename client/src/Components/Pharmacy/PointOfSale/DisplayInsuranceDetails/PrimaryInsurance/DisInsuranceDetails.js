...
export default class AddInsuranceForm extends Component {
	...
	getNetworkPlans() {
		algaehApiCall({
			...
			method: 'GET',
			data: {
				hims_d_insurance_network_office_id: this.state.hims_d_insurance_network_office_id
			},
			onSuccess: (response) => {
					...
					<div className="col-6 primary-details">
						<div className="row">
							<div className="col-6">
								...
								/>
								<h6>
									{this.state.insurance_provider_name ? this.state.insurance_provider_name : '---'}
								</h6>
							</div>
							...
							<div className="col-6">
								...
								/>
								<h6>{this.state.network_type ? this.state.network_type : '---'}</h6>
							</div>
							...
							<div className="col-6">
								...
								/>
								<h6>{this.state.policy_number ? this.state.policy_number : '---'}</h6>
							</div>
							<div className="col-6">
								<AlgaehLabel
									label={{
								...
								/>
								<h6>{this.state.card_number ? this.state.card_number : '---'}</h6>
							</div>
							...
							<div className="col-6">
								...
								<h6>
									{this.state.effective_end_date ? (
										moment(this.state.effective_end_date).format(Options.dateFormat)
									) : (
										'---'
									)}
								</h6>
							...
							<div className="col-6">
								...
								/>
								<h6>{this.state.card_holder_name ? this.state.card_holder_name : '---'}</h6>
							</div>
						</div>
					</div>
