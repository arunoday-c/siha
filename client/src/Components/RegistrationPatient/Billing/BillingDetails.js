		...
		return (			
			<div className="hptl-phase1-billing-details">				
				<div className="tab-container toggle-section">
					...
					<ul className="nav">
						<li className={"nav-item tab-button " + BillingDetails} onClick={this.openTab.bind(this, "Billing-details")}>
							BILLING DETAILS
						</li>
						<li className={"nav-item tab-button " + ReciptDetails} onClick={this.openTab.bind(this, "Recipts-details")}>
							RECIPTS
						</li>
					</ul>
					{/* <div className="row">
