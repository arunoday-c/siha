  ...
  handleCheckIn(patient) {
    ...
    if (!patient.patient_code) {
      ...
      return this.props.history?.push(
        `/FrontDesk?appointment_id=${patient?.hims_f_patient_appointment_id}&status_id=${this.state.checkInId}`
      );
    }

    // return this.props.routeComponents(patient, this.state.checkInId);
    return this.props.history?.push(
      `/FrontDesk?appointment_id=${patient?.hims_f_patient_appointment_id}&patient_code=${patient?.patient_code}&status_id=${this.state.checkInId}`
    );
  }
