    ...
    return (
      <div className="employee_groups margin-top-15">
        <div className="col-lg-12">
          ...
          <div id="projectGrpGrid_Cntr">
            <AlgaehDataGrid
              id="projectGrpGrid"
              data-validate="projectGrpGrid"
              columns={[
                {
                ...
                },
                {
                  ...
                  label: (
                    <AlgaehLabel label={{ forceLabel: "Arabic Description" }} />
                  ),
                  editorTemplate: row => {
                    return (
                      <AlagehFormGroup
                ...
                },
                {
                  ...
                  displayTemplate: row => {
                    return (
                      <span>
                        {moment(row.start_date).format(Options.dateFormat)}
                      </span>
                    );
                  },
                  editorTemplate: row => {
                    return (
                      <AlgaehDateHandler
                        ...
                        textBox={{ className: "txt-fld", name: "start_date" }}
                        events={{
                          onChange: this.grddatehandleEvent.bind(this, row)
                        }}
                ...
                },
                {
                  ...
                  displayTemplate: row => {
                    return (
                      <span>
                        {moment(row.end_date).format(Options.dateFormat)}
                      </span>
                    );
                  },
                  editorTemplate: row => {
                ...
                },
                {
                  ...
                  displayTemplate: row => {
                    return row.pjoject_status === "A" ? "Active" : "Inactive";
                  },
                  editorTemplate: row => {
                    return (
                      <AlagehAutoComplete
                        ...
                        selector={{
                          ...
                          onChange: this.changeGridEditorsEvent.bind(this, row)
                        }}
                      />
                    );
                  }
