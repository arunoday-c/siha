            ...
            return (
              <AlagehFormGroup
                textBox={{
                  ...
                  value: _value,
                  events: {
                    onChange: this.onTextHandleEditChange.bind(
                      this,
                      cellInfo.column.id,
                      cellInfo.index
                    ),
