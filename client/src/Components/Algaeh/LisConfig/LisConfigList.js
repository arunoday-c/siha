                                    ...
                                    <AlgaehDataGrid
                                        ...
                                        columns={[
                                                    ...
                                                    return (
                                                        <span>
                                                            <i
                                                                ...
                                                                onClick={() => { EditLisConfigModel(row) }}
                                                            />
                                                        </span>
                                                    );
                                                },
                                            ...
                                            },
                                            {
                                                ...
                                                label: (
                                                    <AlgaehLabel label={{ forceLabel: "Communication Type" }} />
                                                ),
                                                displayTemplate: row => {
                                                    return (
                                                        <span>
                                            ...
                                            },
                                            {
                                                ...
                                                label: (
                                                    <AlgaehLabel label={{ forceLabel: "IS HL7 SUPPORTED" }} />
                                                ),
                                                displayTemplate: row => {
                                                    return (
                                                        <span>
                                            ...
                                            },
                                            {
                                                fieldName: "check_sum",
                                                label: (
                                                    <AlgaehLabel label={{ forceLabel: "CHECKSUM REQUIRED" }} />
                                                ),
                                                displayTemplate: row => {
                                                    return (
                                                        <span>
                                            ...
                                            },
                                            {
                                                ...
                                                label: (
                                                    <AlgaehLabel label={{ forceLabel: "CONNECTION TYPE" }} />
                                                ),
                                                displayTemplate: row => {
                                                    return (
                                                        <span>
