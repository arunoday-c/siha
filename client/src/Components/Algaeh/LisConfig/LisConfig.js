...
export default function LisConfig(props) {
  ...
  return (
    <div className="LisConfig">
      ...
      >
        <div className="popupInner" style={{ height: "75vh", padding: 15 }}>
          <div className="row">
              ...
              <div className="row">
                          ...
                          <div className="customRadio">
                            <label className="radio inline">
                              <input
                                ...
                                checked={
                                  lis_config.communication_type === "0"
                                    ? true
                                    : false
                                }
                                onChange={EventHandaler}
                            ...
                            <label className="radio inline">
                              <input
                                ...
                                name="communication_type"
                                checked={
                                  lis_config.communication_type === "1"
                                    ? true
                                    : false
                                }
                                onChange={EventHandaler}
                            ...
                            <label className="radio inline">
                              <input
                                ...
                                name="communication_type"
                                checked={
                                  lis_config.communication_type === "2"
                                    ? true
                                    : false
                                }
                                onChange={EventHandaler}
                          ...
                          <div className="customRadio">
                            <label className="radio inline">
                              <input
                                ...
                                name="check_sum"
                                checked={
                                  lis_config.check_sum === "1" ? true : false
                                }
                                onChange={EventHandaler}
                              />
                              <span>Yes</span>
                            ...
                            <label className="radio inline">
                              <input
                                ...
                                name="check_sum"
                                checked={
                                  lis_config.check_sum === "0" ? true : false
                                }
                                onChange={EventHandaler}
                              />
                              <span>No</span>
                          ...
                          <div className="customRadio">
                            <label className="radio inline">
                              <input
                                ...
                                name="order_mode"
                                checked={
                                  lis_config.order_mode === "0" ? true : false
                                }
                                onChange={EventHandaler}
                              />
                            ...
                            <label className="radio inline">
                              <input
                                ...
                                name="order_mode"
                                checked={
                                  lis_config.order_mode === "1" ? true : false
                                }
                                onChange={EventHandaler}
                              />
                            ...
                            <label className="radio inline">
                              <input
                                ...
                                name="order_mode"
                                checked={
                                  lis_config.order_mode === "2" ? true : false
                                }
                                onChange={EventHandaler}
                              />
                              <span>File Mode</span>
                ...
                <div className="col-6">
                  <div className="portlet portlet-bordered margin-bottom-15">
                    <div className="portlet-title">
                      <div className="caption">
                        <h3 className="caption-subject">Driver Information</h3>
                      </div>
                      <div className="actions"></div>
                    </div>
