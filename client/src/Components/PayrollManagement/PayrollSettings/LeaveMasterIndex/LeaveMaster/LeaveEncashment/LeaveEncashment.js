...
function LeaveEncashment(props) {
  ...
  return (
    <div className="col Leave_Encashment">
      <div className="row">
        <div className="col-6">
          <h4>Encashment Rules</h4>
          <div className="row">
            <AlagehAutoComplete
              div={{ className: "col-6 form-group mandatory" }}
              label={{ forceLabel: "Select Encashment Type", isImp: true }}
              selector={{
                name: "earnings_id",
                ...
                columns={[
                  {
                    ...
                    displayTemplate: (row) => {
                      let x = Enumerable.from(myParent.state.earning_deductions)
                        .where(
                          (w) =>
                            w.hims_d_earning_deduction_id === row.earnings_id
                        )
                        .firstOrDefault();
        ...
        <div className="col-6">
          <h4>Exit/Final Encashment Rules</h4>
          <div className="row">
            <AlagehAutoComplete
              div={{ className: "col-6 form-group mandatory" }}
              label={{ forceLabel: "Select Encashment Type", isImp: true }}
