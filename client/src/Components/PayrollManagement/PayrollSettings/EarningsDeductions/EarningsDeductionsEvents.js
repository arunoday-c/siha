...
const onEditHandler = ($this, row) => {
  ...
  edit_data.min_limit_applicable =
    row.min_limit_applicable === "Y" ? true : false;
  ...
  edit_data.indirect_selected_account =
    row.direct_child_id !== null
      ? row.direct_head_id + "-" + row.direct_child_id
      : null;
  edit_data.selected_li_account =
    row.li_child_id !== null ? row.li_head_id + "-" + row.li_child_id : null;
...
const changeChecks = ($this, e) => {
  switch (e.target.name) {
    ...
    case "min_limit_applicable":
      $this.setState({
        min_limit_applicable: !$this.state.min_limit_applicable,
      });
      break;
  ...
  AlgaehValidation({
    ...
    onSuccess: () => {
      if ($this.FIN_Active) {
        ...
        if (
          $this.state.indirect_selected_account === null ||
          $this.state.indirect_selected_account === undefined
        ) {
          swalMessage({
        ...
        if (
          ...
          ($this.state.selected_li_account === null ||
            $this.state.selected_li_account === undefined)
        ) {
          swalMessage({
      ...
      let li_selected_account =
        $this.state.selected_li_account !== null
          ? $this.state.selected_li_account.split("-")
          : [];

      let in_selected_account =
        $this.state.indirect_selected_account !== null
      ...
      let inputObj = {
        ...
        min_limit_applicable:
          $this.state.min_limit_applicable === true ? "Y" : "N",
        min_limit_amount: $this.state.min_limit_amount,
        ...
        direct_child_id:
          in_selected_account.length > 0 ? in_selected_account[1] : undefined,
        direct_head_id:
          in_selected_account.length > 0 ? in_selected_account[0] : undefined,
        li_child_id:
          li_selected_account.length > 0 ? li_selected_account[1] : undefined,
        li_head_id:
          li_selected_account.length > 0 ? li_selected_account[0] : undefined,
      };
