                  ...
                  <div className="receptionNurse">
                    <div className="row">
                      ...
                      <div className="col-12 customCheckbox">
                        ...
                        <label className="checkbox inline">
                          <input type="checkbox" checked={this.state.refill} />
                          <span>Refill</span>
                        </label>{" "}
                        <label className="checkbox inline">
                          <input type="checkbox" checked={this.state.walkin} />
                          <span>Walk In</span>
                        </label>{" "}
                        <label className="checkbox inline">
                          <input
                    ...
                    <div className="row">
                      ...
                      <AlagehFormGroup
                        ...
                        textBox={{
                          ...
                          value: _hims_f_ucaf_header.patient_significant_signs,
                          events: {},
                          option: {
                            type: "text"
                          }
                    ...
                    <div className="row">
                        ...
                        <AlgaehDataGrid
                          ...
                          columns={[
                            ...
                            },
                            {
                              ...
                              label: (
                                <AlgaehLabel
                                  label={{ forceLabel: "Description/Service" }}
                                />
                              )
                            },
                            {
                      ...
                      <div className="col-12">
                        <h5>
                          ...
                          recommended services(s) and allocate cost and complete
                          the following:
                        </h5>
                      </div>
                          ...
                          columns={[
                            {
                              ...
                              label: (
                                <AlgaehLabel
                                  label={{
                                    forceLabel: "Medication Name (Generic Name)"
                                  }}
                                />
                              )
                            },
