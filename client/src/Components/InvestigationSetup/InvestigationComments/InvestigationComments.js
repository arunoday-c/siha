                ...
                <div className="hptl-phase1-add-investigation-form">
                    ...
                    >
                        <div className="popupInner">
                            <div className="col-12 popRightDiv" data-validate="test_comments_data">
                                <div className="row">
                                    <div className="col">
                                        <AlgaehLabel
                                            label={{
                                        ...
                                        columns={[
                                            {
                                                ...
                                                label: <AlgaehLabel label={{ forceLabel: "Comment Name" }} />,
                                                disabled: true
                                            },
                                            {
                                                fieldName: "commet",
                                                label: <AlgaehLabel label={{ forceLabel: "Comment" }} />,
                                                editorTemplate: row => {
                                                    return (
                                                        <AlagehFormGroup
                                                            div={{}}
