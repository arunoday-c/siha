...
class ItemLocationReorder extends Component {
    ...
    addLocationWiseReorder(e) {
        ...
        let location_Exists = reorder_locations.find(f => f.location_id === this.state.location_id)
        ...
        algaehApiCall({
            uri: "/inventory/addInvLocationReorder",
            module: "inventory",
            data: inputObj,
            onSuccess: response => {
    ...
    updateLocationReorder(row) {
        debugger
        algaehApiCall({
            uri: "/inventory/updateInvLocationReorder",
            module: "inventory",
            method: "PUT",
            data: {
    ...
    render() {
        return (
            <div className="ReorderQtyMasterinventoryScreen" style={{ marginTop: 43 }}>
                <AlgaehModalPopUp
                    events={{
                                                    ...
                                                    return (
                                                        ...
                                                        <AlagehFormGroup
                                                            ...
                                                            textBox={{
                                                                ...
                                                                dontAllowKeys: ["-", "e", "."],
                                                                events: {
                                                                    onChange: this.gridtextHandeler.bind(this, row)
                                                                }
                                                            }}
                                                        />
                                                    );
