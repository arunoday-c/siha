...
import {
  ...
  onchangegridcol,
  qtyonchangegridcol,
} from "./POServiceListEvents";

import spotlightSearch from "../../../../Search/spotlightSearch.json";
import _ from "lodash";

export default class POServiceList extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
                ...
                <div className="portlet portlet-bordered margin-bottom-15">
                  <div className="row">
                    <AlgaehAutoSearch
                      ...
                      onClick={servicechangeText.bind(this, this, context)}
                      extraParameters={{
                        service_type_id: 7,
                      }}
                      ref={(attReg) => {
