...
import { onchhangeNumber } from "./ItemListEvents";
...
class ItemList extends Component {
  ...
  render() {
    const isPharmacy = this.context.state.quotation_for === "PHR";
    return (
      <React.Fragment>
                    ...
                    <AlgaehDataGrid
                      ...
                      columns={[
                        ...
                        },
                        {
                          ...
                          label: (
                            <AlgaehLabel label={{ forceLabel: "Unit Price" }} />
                          ),
                          displayTemplate: (row) => {
                            return this.context.state.dataExitst === true ? (
                              row.unit_price
                            ) : (
                              <AlagehFormGroup
                                div={{}}
                                textBox={{
                                  ...
                                  name: "unit_price",
                                  events: {
                                    onChange: onchhangeNumber.bind(this, row),
                                  },
                                }}
                              />
                            );
                        ...
                        },
                        {
                          ...
                          label: (
                            <AlgaehLabel label={{ forceLabel: "Discount %" }} />
                          ),
                          displayTemplate: (row) => {
                            return this.context.state.dataExitst === true ? (
                        ...
                        },
                        {
                          ...
                          label: (
                            <AlgaehLabel label={{ forceLabel: "Tax Amount" }} />
                          ),
                        },
                        {
                          ...
                          displayTemplate: (row) => row.total_amount,
                        },
                      ]}
                      keyId="hims_f_procurement_vendor_quotation_detail_id"
                      dataSource={{
                        data: this.context.state.quotation_detail,
                      }}
                      isEditable={false}
                      byForceEvents={true}
