...
//           display: false
//         },
//         labels: ["Q3 2017", "Q4 2017", "Q1 2019", "Q2 2019"]
//       }
//     ],
//     yAxes: [
//       {
        ...
        <div className="row">
          <div className="col-12">
            <div className="row">
              <div className="col-6">
                <div className="card animated fadeInUp faster">
                  <h6>Test Ordered vs. Completed Trend</h6>
                  <div className="dashboardChartsCntr">
                    <Bar
                      data={orderedVScompleted}
                      options={orderedVScompletedOptions}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="col-12">
                <div className="card animated fadeInUp faster">
                  <h6>Specimen Collection Status - MTD</h6>
                  <div className="dashboardGridCntr">
                    <table className="table  table-bordered table-sm table-striped ">
                      <thead>
                        <tr>
                          <th className="text-center">Status</th>
                          <th className="text-center">Patient Code</th>
                          <th className="text-center">Patient Name</th>
                          <th className="text-center">Ordered Date & Time</th>
                        </tr>
                      </thead>
                      <tbody>
                        {this.state.sample_collection.map((row, index) => (
                          <tr key={index}>
                            ...
                            <td className="text-center">{row.patient_code}</td>
                            <td className="text-center">{row.ordered_date}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
