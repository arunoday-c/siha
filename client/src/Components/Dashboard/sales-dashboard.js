...
export default function Dashboard() {
  ...
  async function getSendInAndSendOutTestDetails(key) {
    ...
    const result = await newAlgaehApi({
      uri: "/SalesDashboard/getSendInAndSendOutTestDetails",
      method: "GET",
      module: "sales",
      data: {
  ...
  async function top10LabOrders(key) {
    ...
    const result = await newAlgaehApi({
      uri: "/SalesDashboard/top10LabOrders",
      method: "GET",
      module: "sales",
      data: {
  ...
  async function getOrderByTestCategory(key) {
    ...
    const result = await newAlgaehApi({
      uri: "/SalesDashboard/getOrderByTestCategory",
      method: "GET",
      module: "sales",
      data: {
        from_date: moment(startOfWeek).format("YYYY-MM-DD"),
  ...
  async function getLabOrderedServices(key) {
    const result = await newAlgaehApi({
      uri: "/SalesDashboard/getLabOrderedServices",
      module: "laboratory",
      method: "GET",
    });
    return result?.data?.records;
  ...
  async function labDashBoardWithAttachment(reportParams) {
    ...
    // try {
    const result = await newAlgaehApi({
      uri: "/SalesDashboard/labDashBoardWithAttachment",
      module: "laboratory",
      method: "GET",
      data: {
        ...reportParams,
