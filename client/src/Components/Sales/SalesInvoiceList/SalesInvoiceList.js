                                        ...
                                        columns={[
                                                    ...
                                                    return (
                                                        <span>
                                                            <i
                                                                ...
                                                                onClick={() => {
                                                                    this.props.history.push(`/SalesInvoice?invoice_number=${row.invoice_number}`)
                                                                }}
                                                            />
                                                            <i
                                                                className="fas fa-eye"
                                                                onClick={() => {
                                                                    this.props.history.push(`/SalesOrder?sales_order_number=${row.sales_order_number}`)
                                                                }}
                                                            />
                                                        </span>
                                                    );
                                            ...
                                            },
                                            {
                                                ...
                                                displayTemplate: row => {
                                                    return (
                                                        <span>
                                                            {dateFormater(this, row.invoice_date)}
                                                        </span>
                                                    );
                                                },
                                            ...
                                            },
                                            {
                                                ...
                                                displayTemplate: row => {
                                                    return (
                                                        <span>
                                                            {dateFormater(this, row.sales_order_date)}
                                                        </span>
                                                    );
                                                },
