...
const deleteSalesDetail = ($this, context, row) => {
  ...
  if (
    row.hims_f_sales_quotation_items_id !== undefined &&
    row.hims_f_sales_quotation_items_id !== null
  ) {
  ...
  if (sales_quotation_items.length === 0) {
    ...
    const total_item_amount =
      sales_quotation_items.length === 0
        ? 0
        : _.sumBy(sales_quotation_items, (s) => parseFloat(s.total_amount));
