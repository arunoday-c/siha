...
class SalesQuotation extends Component {
  ...
  componentDidMount() {
    ...
    if (queryParams.get("sales_quotation_number")) {
      getCtrlCode(this, queryParams.get("sales_quotation_number"));
    }
  }
                      ...
                      <div className="col-12">
                        <div className="row">
                          <div className="col-3">
                            ...
                            <h6>
                              {GetAmountFormart(this.state.total_item_amount)}
                            </h6>
                          </div>
                          ...
                          <div className="col-3">
                            ...
                            <h6>
                              {GetAmountFormart(
                                this.state.total_service_amount
                              )}
                            </h6>
                          </div>
