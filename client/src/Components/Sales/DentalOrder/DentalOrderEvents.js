...
const customerTexthandle = ($this, e) => {
  ...
  if ($this.state.sales_order_mode === "I") {
    ...
    algaehApiCall({
      uri: "/DentalOrder/ValidateContract",
      module: "sales",
      method: "GET",
...
const SalesQuotationSearch = ($this, e) => {
  ...
  AlgaehSearch({
    ...
    onRowSelect: (row) => {
      AlgaehLoader({ show: true });
      algaehApiCall({
        uri: "/DentalOrder/getSalesQuotationForOrder",
        module: "sales",
        method: "GET",
        data: {
...
const ContractSearch = ($this, e) => {
  ...
  AlgaehSearch({
    ...
    onRowSelect: (row) => {
      AlgaehLoader({ show: true });
      algaehApiCall({
        uri: "/DentalOrder/getContractDentalOrder",
        module: "sales",
        method: "GET",
        data: {
...
const SaveDentalOrderEnrty = ($this, from) => {
  AlgaehValidation({
    ...
    onSuccess: () => {
      ...
      if (InputObj.hims_f_sales_order_id !== null) {
        strUri = "/DentalOrder/postDentalOrder";
      } else {
        strUri = "/DentalOrder/addDentalOrder";
      }
...
const getCtrlCode = ($this, saveDocument, docNumber) => {
  AlgaehLoader({ show: true });
  algaehApiCall({
    uri: "/DentalOrder/getDentalOrder",
    module: "sales",
    method: "GET",
    data: {
...
const generateDentalOrderReport = (data) => {
      ...
      report: {
        reportName:
          data.sales_order_mode === "S"
            ? "DentalOrderReportService"
            : "DentalOrderReportItem",
        reportParams: [
          {
...
const AuthorizeOrderEntry = ($this, authorize) => {
  ...
  const settings = { header: undefined, footer: undefined };
  algaehApiCall({
    uri: "/DentalOrder/updateDentalOrderEntry",
    module: "sales",
    method: "PUT",
    skipParse: true,
...
const RejectSalesServiceOrder = ($this) => {
  ...
  algaehApiCall({
    uri: "/DentalOrder/rejectSalesServiceOrder",
    module: "sales",
    data: $this.state,
    method: "PUT",
    onSuccess: (response) => {
...
const CancelSalesServiceOrder = ($this) => {
  ...
  algaehApiCall({
    uri: "/DentalOrder/cancelSalesServiceOrder",
    module: "sales",
    data: $this.state,
    method: "PUT",
    onSuccess: (response) => {
