      ...
      <div className="col-lg-8">
            ...
            <div className="portlet portlet-bordered box-shadow-normal margin-bottom-15">
              ...
              <h6 className="smallh6">Chief Complaint</h6>
                <div className="row">
                <div className="col">
                <h6 className="danger">History of Convlusion with fever (Febrile Convlusion)</h6>
                </div>
              </div>
              </div>
              </div>
              ...
              <h6 className="smallh6">Diagnosis</h6>
                <div className="row">
                <div className="col">
                <h6 className="danger">Primary: History of Convlusion with fever (Febrile Convlusion)</h6>
                </div>

                <div className="col">
                <h6 className="">Secondary: History of Convlusion with fever (Febrile Convlusion)</h6>
                </div>
              </div>
              </div>
              </div>
              ...
              <h6 className="smallh6">Investigation</h6>
                <div className="row">
                <div className="col-lg-12">
                <h6 className="">History of Convlusion with fever (Febrile Convlusion)<span>View Report</span></h6>
                </div>
              ...
              <h6 className="smallh6">Medication</h6>
                <div className="row">
                <div className="col-lg-12"><AlgaehDataGrid
                id="index"
                columns={[
                  {
                    fieldName: "index",
