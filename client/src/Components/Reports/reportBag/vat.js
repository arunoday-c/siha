export default function Vat({
  ...
  return {
    ...
    submenu: [
      ...
      {
        subitem: "Purchase Tax Report - Summary",
        reportName: "PurchaseTaxSummaryReport",
        componentCode: "RPT_PUR_VAT_SUM",
        requireIframe: true,
        pageSize: "A4",
        pageOrentation: "landscape", //"portrait",
        reportParameters: [
      ...
      {
        subitem: "Purchase Tax Report - Detail",
        reportName: "PurchaseTaxDetailReport",
        componentCode: "RPT_PUR_VAT_DTL",
        requireIframe: true,
        pageSize: "A4",
        pageOrentation: "landscape", //"portrait",
        reportParameters: [
