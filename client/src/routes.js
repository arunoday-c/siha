...
const BatchGeneration = React.lazy(() =>
  retry(() => import("./Components/Laboratory/BatchGeneration"))
);
...
const CustomerContractList = React.lazy(() =>
  retry(() =>
    import("./Components/Sales/CustomerContractList/CustomerContractList")
  )
);
