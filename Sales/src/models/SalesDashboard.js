...
export default {
  ...
  top10LabOrders: (req, res, next) => {
    ...
    try {
      ...
      _mysql
        .executeQuery({
          query: `SELECT IM.item_description,SUM(NB.total_amount) AS total_amount,count(NB.item_id) as item_count
          ...
          GROUP BY NB.item_id order by item_count DESC limit 0,10;`,
