            ...
            if (headerResult[0].po_from == "INV") {
              strQuery = mysql.format(
                "select PD.`hims_f_procurement_po_detail_id`, PD.`procurement_header_id`, PD.`phar_item_category`,\
                   ...
                   IU.uom_description,S.standard_fee as sales_price,IM.sales_uom_id from hims_f_procurement_po_detail PD,\
                    hims_d_inventory_item_master IM ,hims_d_inventory_uom IU, hims_d_services S \
              ...
              strQuery = mysql.format(
                ...
                PU.uom_description, S.standard_fee as sales_price,IM.sales_uom_id\
