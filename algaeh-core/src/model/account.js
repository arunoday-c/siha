...
let authUser = (req, res, next) => {
  ...
  try {
    ...
    _mysql
      .executeQuery({
        query:
          "SELECT  algaeh_d_app_user_id, username,E.followup_alert_required, user_display_name,  employee_code, locked, user_type,login_attempts,\
     ...
     SELECT ORG.product_name,ORG.product_type, ORG.business_registration_number,ORG.tax_number,ORG.other_lang,\
     ORG.other_lang_short,hims_d_hospital_id, hospital_code, local_vat_applicable, default_nationality, default_country, \
   H.default_currency, H.default_slot, H.default_patient_type, H.standard_from_time, H.standard_to_time, H.hospital_name,portal_exists, bill_cancel_approval_required, \
   ...
   default_pay_type, vat_applicable, vat_percent, admission_exists FROM hims_d_hospital H, hims_d_currency CUR,hims_d_organization ORG WHERE H.record_status='A' AND \
