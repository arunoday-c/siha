  ...
  let queries = {
    algaehSeach: [
      {
        searchName: "patients",
        searchQuery:
          "select SQL_CALC_FOUND_ROWS  hims_d_patient_id, patient_code,primary_id_no, full_name, arabic_name, \
          tel_code, contact_number, employee_id, age, date_of_birth, gender, email, title_id, secondary_id_no  from hims_f_patient \
      ...
      },
      {
        ...
        searchQuery:
          "select SQL_CALC_FOUND_ROWS hims_d_inventory_item_master_id, item_description, \
            ...
            IL.expirydt,IL.barcode,IL.qtyhand,IL.sales_uom,category_id,group_id,IL.sale_price,\
            ...
            and IL.qtyhand > 0 and (date(expirydt) > date(CURDATE()) || exp_date_required='N') \
            and {mapper} \
            union \
            ...
            group_id, ITL.sale_price,ITL.inventory_location_id FROM hims_d_services_insurance INS,  hims_d_inventory_item_master IM, hims_m_inventory_item_location ITL where \
            INS.services_id = IM.service_id and IM.hims_d_inventory_item_master_id = ITL.item_id and \
            insurance_id=? and ITL.inventory_location_id=?  and ITL.qtyhand > 0 and (date(expirydt) > date(CURDATE()) || exp_date_required='N')\
            and {mapper} and service_type_id=4",
    ...
    left join hims_d_title as T on T.his_d_title_id = E.title_id \
      ...
      },
      {
        ...
        orderBy: "A.hims_adm_atd_admission_id desc",
      },
      ...search_global1,
    ],
  };
