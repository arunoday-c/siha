  ...
  getStockAdjustment: (req, res, next) => {
    ...
    try {
      ...
      if (req.query.transaction_id != null) {
        strQty += ` and hims_f_pharmacy_stock_adjust_header_id= '${req.query.transaction_id}'`;
      }
        ...
        .executeQuery({
          query:
            "SELECT AH.*, L.location_description as location_name from hims_f_pharmacy_stock_adjust_header AH, \
                        hims_d_pharmacy_location L where L.hims_d_pharmacy_location_id = AH.location_id "+ strQty,
      ...
      _mysql
        ...
        .then((headerResult) => {
          ...
          _mysql
            .executeQuery({
              query:
                "INSERT INTO hims_f_pharmacy_stock_adjust_detail(??) VALUES ?",
