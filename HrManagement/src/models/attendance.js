                  ...
                  switch (day["worked_status"]) {
                    case "AB":
                      if (
                        ...
                        req.records = {
                          invalid_input: true,
                          message: `${employee["employee_code"]} on  ${moment(
                            day.attendance_date,
                            "YYYY-MM-DD"
                          ).format("DD-MM-YYYY")} is ${day["status"]} not  PR`
                        };
                        next();
                        return;
                      }
                      ...
                      if (day["worked_status"] == day["status"]) {
                        ...
                        req.records = {
                          ...
                          message: `${employee["employee_code"]} on  ${moment(
                            day.attendance_date,
                            "YYYY-MM-DD"
                          ).format("DD-MM-YYYY")} is ${actual} not ${neww}`
                        };
                        next();
                        return;
                      }
                      ...
                      if (day["worked_status"] !== day["status"]) {
                        req.records = {
                          ...
                          message: `${employee["employee_code"]} on  ${moment(
                            day.attendance_date,
                            "YYYY-MM-DD"
                          ).format("DD-MM-YYYY")} is ${day["status"]} not  N`
                        };
                        next();
                        return;
                      }
                    ...
                    default:
                      if (day["status"] != "N") {
                        ...
                        req.records = {
                          invalid_input: true,
                          message: `No project is Assigned for ${
                            employee["employee_code"]
                          } on  ${moment(
                            day.attendance_date,
                            "YYYY-MM-DD"
