      ...
      .then(empResult => {
       ...
       hims_d_holiday where record_status='A' and  \
          ...
          and (weekoff='Y' or holiday='Y') and hospital_id=?",
                            ...
                            _mysql
                              ...
                              .then(monthlyLeaveResult => {
                                ...
                                _mysql
                                        ...
                                        .then(attDataResult => {
                                          if (req.mySQl == null) {
                                            ...
                                            if (
                                              ...
                                              req.onSuccess(attDataResult);
                                            }
                                          }
                                        })
                                        .catch(e => {
                                          if (
                                            typeof req.onFailure == "function"
                                          )
                                            req.onFailure({
                                              no_data: true,
                                  ...
                                  .catch(e => {
                                    if (typeof req.onFailure == "function")
                                      req.onFailure({
                                        no_data: true,
                                        message: "No Employees found"
                                      });
            ...
            .catch(e => {
              if (typeof req.onFailure == "function")
                req.onFailure({ no_data: true, message: "No Employees found" });
              next(e);
            });
        } else {
          if (req.mySQl == null) {
