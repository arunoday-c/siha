          ...
          if (
            ...
            _mysql
              ...
              .then((childRes) => {
                ...
                country_id, state_id, city_id, bank_account_no, vat_number, aiban_number\
      ...
      _mysql
        .executeQuery({
          query:
            ...
            bank_account_no=?, vat_number=?,aiban_number=?,\
    ...
    try {
      ...
      _mysql
        .executeQuery({
          ...
          postal_code,address, country_id, state_id, city_id, bank_account_no, vat_number,aiban_number \
