...
exports.default = function (_ref) {
  ...
  api.post("/add", _patientRegistration.addPatientToRegisteration, function (req, res, next) {
  ...
  api.put("/update", _patientRegistration.updatePatientRegistrstion, function (req, res, next) {
    var result = req.records;
    res.status(_httpStatus2.default.ok).json({
      success: true,
      records: result
  ...
  api.get("/get", _patientRegistration.patientSelect, function (req, res, next) {
    var result = req.records;
