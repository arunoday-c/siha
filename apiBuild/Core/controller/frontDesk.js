...
exports.default = function (_ref) {
  ...
  // created by irfan :to
  api.get("/getCashHandoverDetails", _frontDesk.getCashHandoverDetails, function (req, res, next) {
  ...
  // created by irfan :to
  api.put("/updateCashHandoverDetails", _frontDesk.updateCashHandoverDetails, function (req, res, next) {
    var result = req.records;
    res.status(_httpStatus2.default.ok).json({
      success: true,
      records: result
