...
var _opBillCancellation = require("../model/opBillCancellation");
...
exports.default = function (_ref) {
  ...
  api.post("/addOpBillCancellation", _utils.generateDbConnection, _receiptentry.ReceiptPaymentInsert, _opBillCancellation.addOpBillCancellation, _opBillCancellation.updateOPBilling, function (req, res, next) {
  ...
  api.get("/getBillCancellation", _utils.generateDbConnection, _opBillCancellation.getBillCancellation, _receiptentry.getReceiptEntry, function (req, res, next) {
