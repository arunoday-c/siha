  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.beginTransaction(function (error) {
        ...
        connection.query("INSERT INTO `hims_d_inventory_item_master` (`item_code`, `item_description`,item_type, `structure_id`,\
        ...
        VALUE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [input.item_code, input.item_description, input.item_type, input.structure_id, input.category_id, input.group_id, input.item_uom_id, input.purchase_uom_id, input.sales_uom_id, input.stocking_uom_id, input.service_id, input.addl_information, input.decimals, input.purchase_cost, input.markup_percent, input.sales_price, new Date(), input.created_by, new Date(), input.updated_by], function (error, result) {
          ...
          if (result.insertId != null) {
            ...
            connection.query("INSERT INTO hims_m_inventory_item_uom(" + insurtColumns.join(",") + ",item_master_id,created_date,updated_date) VALUES ?", [(0, _utils.jsonArrayToObject)({
...
var addItemCategory = function addItemCategory(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("INSERT INTO `hims_d_inventory_tem_category` (`category_desc`, `created_date`, `created_by`, `updated_date`, `updated_by`)\
...
var addItemGroup = function addItemGroup(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("INSERT INTO `hims_d_inventory_item_group` (`group_description`, `category_id`, `created_by`, `created_date`, `updated_by`, `updated_date`) \
...
var addInventoryUom = function addInventoryUom(req, res, next) {
  try {
    if (req.db == null) {
      next(_httpStatus2.default.dataBaseNotInitilizedError());
    }
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("INSERT INTO `hims_d_inventory_uom` (`uom_description`, `created_date`, `created_by`, `updated_date`, `updated_by`)\
...
var addInventoryLocation = function addInventoryLocation(req, res, next) {
  try {
    if (req.db == null) {
      next(_httpStatus2.default.dataBaseNotInitilizedError());
    }
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("INSERT INTO `hims_d_inventory_location` (`location_description`,  `location_type`, `allow_pos`, `created_date`, `created_by`, `updated_date`, `updated_by`)\
...
var getItemMaster = function getItemMaster(req, res, next) {
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select * FROM hims_d_inventory_item_master where record_status='A' AND" + where.condition, where.values, function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var getItemMasterAndItemUom = function getItemMasterAndItemUom(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select  MIU.hims_m_inventory_item_uom_id, MIU.item_master_id, MIU.uom_id,PH.uom_description, MIU.stocking_uom, \
        ...
        left join hims_d_inventory_uom PH  on  MIU.uom_id=PH.hims_d_inventory_uom_id;", function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var getItemCategory = function getItemCategory(req, res, next) {
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select * FROM hims_d_inventory_tem_category where record_status='A' AND" + where.condition, where.values, function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var getItemGroup = function getItemGroup(req, res, next) {
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select * FROM hims_d_inventory_item_group where record_status='A' AND" + where.condition, where.values, function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var getInventoryUom = function getInventoryUom(req, res, next) {
  var selectWhere = {
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select * FROM hims_d_inventory_uom where record_status='A' AND " + where.condition, where.values, function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var getInventoryLocation = function getInventoryLocation(req, res, next) {
  var selectWhere = {
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select * FROM hims_d_inventory_location where record_status='A' AND" + where.condition, where.values, function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var updateItemCategory = function updateItemCategory(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("UPDATE `hims_d_inventory_tem_category` SET `category_desc`=?, `category_status`=?,\
        `updated_date`=?, `updated_by`=?, `record_status`=?\
        WHERE `hims_d_inventory_tem_category_id`=? and `record_status`='A';", [input.category_desc, input.category_status, new Date(), input.updated_by, input.record_status, input.hims_d_inventory_tem_category_id], function (error, result) {
        connection.release();
        if (error) {
          next(error);
        }
...
var updateItemGroup = function updateItemGroup(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("UPDATE `hims_d_inventory_item_group` SET `group_description`=?, `category_id`=?, `group_status`=?,\
        `updated_by`=?, `updated_date`=?, `record_status`=? WHERE  `record_status`='A' and `hims_d_inventory_item_group_id`=?;", [input.group_description, input.category_id, input.group_status, input.updated_by, new Date(), input.record_status, input.hims_d_inventory_item_group_id], function (error, result) {
        connection.release();
        if (error) {
          next(error);
        }
...
var updateInventoryUom = function updateInventoryUom(req, res, next) {
  try {
    if (req.db == null) {
      next(_httpStatus2.default.dataBaseNotInitilizedError());
    }
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("UPDATE `hims_d_inventory_uom` SET `uom_description`=?,\
        `updated_date`=?, `updated_by`=?, `record_status`=? WHERE record_status='A' and`hims_d_inventory_uom_id`=?;", [input.uom_description, new Date(), input.updated_by, input.record_status, input.hims_d_inventory_uom_id], function (error, result) {
        connection.release();
        if (error) {
          next(error);
        }
...
var updateInventoryLocation = function updateInventoryLocation(req, res, next) {
  try {
    if (req.db == null) {
      next(_httpStatus2.default.dataBaseNotInitilizedError());
    }
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("UPDATE `hims_d_inventory_location` SET `location_description`=?, `location_status`=?, `location_type`=?, `allow_pos`=?,\
         `updated_date`=?,`updated_by`=?, `record_status`=? WHERE `record_status`='A' and `hims_d_inventory_location_id`=?;", [input.location_description, input.location_status, input.location_type, input.allow_pos, new Date(), input.updated_by, input.record_status, input.hims_d_inventory_location_id], function (error, result) {
        connection.release();
        if (error) {
          next(error);
        }
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.beginTransaction(function (error) {
        ...
        var queryBuilder = "UPDATE `hims_d_inventory_item_master` SET `item_code`=?, `item_description`=?, `structure_id`=?,\
        ...
        var inputs = [input.item_code, input.item_description, input.structure_id, input.category_id, input.group_id, input.item_uom_id, input.purchase_uom_id, input.sales_uom_id, input.stocking_uom_id, input.item_status, input.service_id, input.item_type, input.addl_information, input.decimals, input.purchase_cost, input.markup_percent, input.sales_price, new Date(), input.updated_by, input.record_status, input.hims_d_inventory_item_master_id];
            ...
            new Promise(function (resolve, reject) {
              try {
                if (input.insertItemUomMap.length != 0) {
                  ...
                  connection.query("INSERT INTO hims_m_inventory_item_uom(" + insurtColumns.join(",") + ",created_date,updated_date) VALUES ?", [(0, _utils.jsonArrayToObject)({
                    sampleInputObject: insurtColumns,
              ...
              if (input.updateUomMapResult.length != 0) {
                ...
                for (var i = 0; i < req.body.updateUomMapResult.length; i++) {
                  qry += "UPDATE `hims_m_inventory_item_uom` SET item_master_id='" + inputParam[i].item_master_id + "', uom_id='" + inputParam[i].uom_id + "', stocking_uom='" + inputParam[i].stocking_uom + "', conversion_factor='" + inputParam[i].conversion_factor + "', record_status='" + inputParam[i].record_status + "', updated_date='" + new Date().toLocaleString() + "',updated_by='" + req.body.updated_by + "' WHERE record_status='A' and hims_m_inventory_item_uom_id='" + inputParam[i].hims_m_inventory_item_uom_id + "';";
                }
...
var addLocationPermission = function addLocationPermission(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("INSERT INTO `hims_m_inventory_location_permission` (`user_id`, `location_id`, `allow`,`created_date`,`created_by`)\
...
var getLocationPermission = function getLocationPermission(req, res, next) {
  ...
  try {
    ...
    db.getConnection(function (error, connection) {
      connection.query("select * FROM hims_m_inventory_location_permission where record_status='A' AND" + where.condition, where.values, function (error, result) {
        (0, _utils.releaseDBConnection)(db, connection);
        if (error) {
          next(error);
        }
...
var updateLocationPermission = function updateLocationPermission(req, res, next) {
  try {
    ...
    db.getConnection(function (error, connection) {
      ...
      connection.query("UPDATE `hims_m_inventory_location_permission` SET `user_id`=?, `location_id`=?,\
        `allow`=?, `updated_date`=?, `updated_by`=?, `record_status`=?\
        WHERE `hims_m_inventory_location_permission_id`=? and `record_status`='A';", [input.user_id, input.location_id, input.allow, new Date(), input.updated_by, input.record_status, input.hims_m_inventory_location_permission_id], function (error, result) {
        connection.release();
        if (error) {
          next(error);
        }
