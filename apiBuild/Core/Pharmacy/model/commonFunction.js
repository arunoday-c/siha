...
var updateIntoItemLocation = function updateIntoItemLocation(req, res, next) {
  ...
  db.getConnection(function (error, connection) {
    ...
    new _nodeLinq.LINQ(inputParam.pharmacy_stock_detail).Select(function (s) {
    ...
    connection.query(" call algaeh_proc_item_location ('" + xmlQuery + "')", function (error, result) {
...
module.exports = {
  updateIntoItemLocation: updateIntoItemLocation
};
