...
var _POSCreditSettlement = require("../model/POSCreditSettlement");
...
exports.default = function (_ref) {
  ...
  api.post("/addPOSCreidtSettlement", _utils.generateDbConnection, _pharmacyGlobal.pharmacyReceiptInsert, _POSCreditSettlement.addPOSCreidtSettlement, _POSCreditSettlement.updatePOSBilling, function (req, res, next) {
  ...
  api.get("/getPOSCreidtSettlement", _utils.generateDbConnection, _POSCreditSettlement.getPOSCreidtSettlement, _receiptentry.getReceiptEntry, function (req, res, next) {
  ...
  api.get("/getPatientPOSCriedt", _POSCreditSettlement.getPatientPOSCriedt, function (req, res, next) {
    var result = req.records;
    if (result.length == 0) {
