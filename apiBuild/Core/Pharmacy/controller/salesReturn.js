...
var _salesReturn = require("../model/salesReturn");
...
exports.default = function (_ref) {
  ...
  api.post("/addsalesReturn", _utils.generateDbConnection, _pharmacyGlobal.pharmacyReceiptInsert, _salesReturn.addsalesReturn, _salesReturn.updatesalesReturn, function (req, res, next) {
  ...
  api.get("/getsalesReturn", _utils.generateDbConnection, _salesReturn.getsalesReturn, _receiptentry.getReceiptEntry, function (req, res, next) {
    var connection = req.connection;
    connection.commit(function (error) {
      (0, _logging.debugLog)("error", error);
      (0, _logging.debugLog)("commit error", error);
      if (error) {
        ...
        var _sales = req.records;

        var result = _extends({}, _receptEntry, _sales);
  ...
  api.put("/updatesalesReturn", _salesReturn.updatesalesReturn, function (req, res, next) {
