...
export function reSubmissionDetails(req, res, next) {
  ...
  try {
    _mysql
      ...
      SUM(if(claim_status='R2',remittance_amount2,if(claim_status='R3',remittance_amount3,remittance_amount))) as total_remittance_amount,
      SUM(if(claim_status='R2',denial_amount2,if(claim_status='R3',denial_amount3,denial_amount))) as total_denial_amount,
      MAX(if(claim_status='R2',insurance_statement_id_2,if(claim_status='R3',insurance_statement_id_3,insurance_statement_id))) as insurance_statement_id
      ...
      .then((result) => {
        ...
        _mysql
          ...
          .then((records) => {
            ...
            const newNumber =
              insurance_statement_number + "-RESUB-" + submission_step;
            _mysql
              .executeQuery({
